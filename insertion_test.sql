...
INSERT INTO users (persona_id, password_hash) VALUES
(6, '$2y$10$abcdefghijklmnopqrstuvwxyz1234567890'),
(7, '$2y$10$1234567890abcdefghijklmnopqrstuvwxyz');
...
-- Insertar Pedidos
INSERT INTO Pedidos (cliente_id, metodo_pago, total, user_id, estado, tipo_pedido) VALUES
(1, 'efectivo', 60000, 1, 'pendiente', 'domicilio'),
(2, 'tarjeta', 45000, 1, 'pendiente', 'domicilio'),
(3, 'transferencia', 80000, 2, 'pendiente', 'local'),
(4, 'wallet', 35000, 1, 'pendiente', 'llevar'),
(5, 'efectivo', 90000, 2, 'pendiente', 'domicilio');
